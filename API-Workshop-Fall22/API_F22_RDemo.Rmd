...
get_all_tweets(
  query = "Halloween", # keyword search (what are some keywords that align with important dates?)
  start_tweets = "2021-10-24T00:00:00Z",
...
count_all_tweets(
  ...
  start_tweets = "2020-10-15T00:00:00Z",
  end_tweets = "2020-11-15T00:00:00Z",
  # bearer_token = "",
...
profile_tweets <-
  get_all_tweets(
    users = c("pete_enns"),
    start_tweets = "2020-10-15T00:00:00Z",
    end_tweets = "2020-10-22T00:00:00Z",
    # bearer_token = "",
    n = 100
  )
...
thread_tweets <-
  get_all_tweets(
  # Replace with Tweet ID of your choice to get replies (this ID is from the Halloween original set)
  conversation_id = "1454363540245069827",
  start_tweets = "2021-10-24T00:00:00Z",
  end_tweets = "2021-10-31T00:00:00Z",
  bind_tweets = TRUE,
  n = 100,
...
ex_geo <-
 get_all_tweets(
  query = "#vote", # what if we want to find #vote tweets from specific cities/counties? maybe they are geotagged...
  start_tweets = "2020-11-03T00:00:00Z",
  end_tweets = "2020-11-04T00:00:00Z",
  n = 20, #set an upper limit. The default is 100. 
  has_geo = TRUE,
  # bearer_token = "",
)
...
adv_tweets <- 
  get_all_tweets(
    ...
    end_tweets = "2020-11-04T00:00:00Z",
    n = 20, #set an upper limit. The default is 100. 
    place = "ithaca", is_verified = FALSE,  
